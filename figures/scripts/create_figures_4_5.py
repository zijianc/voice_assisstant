...
def create_figure4_vad_comparison():
    ...
    plt.tight_layout()
    plt.savefig('../output/Figure4_Enhanced_VAD_Performance.png', dpi=300, bbox_inches='tight')
    plt.savefig('../output/Figure4_Enhanced_VAD_Performance.pdf', bbox_inches='tight')
...
def create_figure5_interruption_performance():
    ...
    plt.tight_layout()
    plt.savefig('../output/Figure5_Enhanced_Interruption_Performance.png', dpi=300, bbox_inches='tight')
    plt.savefig('../output/Figure5_Enhanced_Interruption_Performance.pdf', bbox_inches='tight')
