...
def load_actual_data():
    ...
    # Load wake-word data
    try:
        wakeword_df = pd.read_csv('rigorous_wakeword_data_20250929_032437.csv')
...
def create_figure2_enhanced(data):
    ...
    plt.tight_layout()
    plt.savefig('Figure2_Enhanced_Latency_Performance.png', dpi=300, bbox_inches='tight')
    plt.savefig('Figure2_Enhanced_Latency_Performance.pdf', bbox_inches='tight')
...
def create_figure3_wakeword_enhanced():
    ...
    plt.tight_layout()
    plt.savefig('Figure3_Enhanced_Wake_Word_Performance.png', dpi=300, bbox_inches='tight')
    plt.savefig('Figure3_Enhanced_Wake_Word_Performance.pdf', bbox_inches='tight')
